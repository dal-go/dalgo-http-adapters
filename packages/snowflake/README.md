...
Tooling: pnpm 11.20, TypeScript 6, ESLint and Vitest. CI typechecks the adapter, tests and example, runs tests, and builds ESM/declarations. GitHub default CodeQL is used; no custom CodeQL workflow is included. Packaging follows the [Firestore adapter](../firestore).
